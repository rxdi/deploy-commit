...
import { COMMAND_PARSER, REACTIVE_JSON, PACKAGE_JSON, COMMANDS } from "./app.injection";
...
imports: [CoreModule],
  providers: [
    ...
    },
    {
      ...
      lazy: true,
      useFactory: async (commandParser: COMMANDS[], executor: ExecutorService) => executor.execute(commandParser)
    }
  ],
})
