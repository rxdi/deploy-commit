...
export declare class TransactionService {
    ...
    private command;
    path: string;
    constructor(graphService: GraphService, tLogger: LoggerService, spinner: SpinnerService, fileService: FileService, reactiveJson: REACTIVE_JSON, command: COMMAND_PARSER);
    scan(): Promise<string[]>;
